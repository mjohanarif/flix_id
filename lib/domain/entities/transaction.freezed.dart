...
mixin _$Transaction {
  ...
  int? get watchTime => throw _privateConstructorUsedError;
...
class _$TransactionImpl implements _Transaction {
  const _$TransactionImpl(
      ...
      required this.title,
      final List<String> seats = const <String>[],
      this.theaterName,
      this.watchTime,
      this.ticketAmount,
      this.ticketPrice,
  ...
  @override
  String toString() {
    return 'Transaction(id: $id, uid: $uid, transactionTime: $transactionTime, transactionImage: $transactionImage, title: $title, seats: $seats, theaterName: $theaterName, watchTime: $watchTime, ticketAmount: $ticketAmount, ticketPrice: $ticketPrice, adminFee: $adminFee, total: $total)';
  }
